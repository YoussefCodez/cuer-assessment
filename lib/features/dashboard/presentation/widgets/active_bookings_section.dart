// lib/features/dashboard/presentation/widgets/active_bookings_section.dart
...
/// Displays the active bookings section with a list of booking cards.
class ActiveBookingsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          DashboardStrings.activeBookingsTitle,
          style: TextStyle(
        ...
        if (bookings.isEmpty)
          const EmptyStateWidget(
            message: DashboardStrings.noActiveBookings,
